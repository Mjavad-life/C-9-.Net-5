...
Console.WriteLine("p.ToString() after reset={0}", p.ToString());
Console.WriteLine();
...
Console.WriteLine("p2.ToString() after reset ={0}", p2.ToString());
Console.WriteLine();
...
Console.WriteLine("p3.ToString() after reset ={0}", p3.ToString());
//Console.ReadLine();
Console.WriteLine();

// using default for complex types
Point<string> p4 = default;
Console.WriteLine("p4.ToString()={0}", p4.ToString());
Console.WriteLine();

// second point is int type
